...
Arduino IDE v2.3.4
ESP32 Board v2.0.16
Arduino_GFX_Library v.1.5.6
*/
#include <Arduino_GFX_Library.h>

Arduino_DataBus *bus = new Arduino_ESP32SPI(21 /* DC */, 15 /* CS */, 14 /* SCK */, 13 /* MOSI */, 12 /* MISO */);
Arduino_GFX *gfx = new Arduino_ILI9488_18bit(bus, GFX_NOT_DEFINED /* RST */, 0 /* rotation */, false /* IPS */);
